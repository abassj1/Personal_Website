                ...
                <div id="stack1" class="card-container relative h-1/2 w-full start">
                    <div id="card1" class="card h-72 items-center p-6 bg-whatsapp_auto bg-cover rounded-large drop-shadow-2xl card1">
                        <div class="flex mt-2 mr-4 items-center w-96">                    
                            <h1 className="text-lg font-extrabold text-blitblue-500">WhatsApp Automation</h1>
                        </div>  
                    ...
                    <div id="card2" class="card h-72 items-center p-6 bg-blitcoreWebpage bg-cover rounded-large drop-shadow-2xl card2">
                        <div class="flex mt-2 mr-4 items-center w-96">                    
                    ...
                    <div id="card3" class="card h-72 items-center p-6 bg-whatsapp_auto bg-cover rounded-large drop-shadow-2xl card3">
                        <div class="flex mt-2 mr-4 items-center w-96">                    
                            <h1 className="text-lg font-extrabold text-blitblue-500">WhatsApp Automation</h1>
                        </div>  
